    ...
    return (
        <div>
            <span className='flex justify-between w-full'>
                ...
                <motion.span style={{ display: useTransform(hoverScrollHeight, [0, 1, 80], ['none', 'block', 'none']) }} className='w-[60%] h-[50vh] absolute left-[40%] top-4 flex flex-col border border-gray-700 rounded-md divide-y-2 divide-gray-700 items-start justify-start'>
