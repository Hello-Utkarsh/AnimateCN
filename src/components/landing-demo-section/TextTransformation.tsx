    ...
    return (
        <div>
            <span className='flex justify-between w-full'>
                <motion.span
                    className='flex gap-4 w-[30%] items-center relative'
                    style={{ marginTop: useTransform(textScrollHeight, [0, 1], [0, 30]), marginBottom: useTransform(textScrollHeight, [0, 1], [0, 30]), height: useTransform(textScrollHeight, [0, 1, 1, 80], [40, 40, 85, 85]) }}>
                    <motion.div
                        style={{ opacity: useTransform(textScrollHeight, [0, 1, 79, 80], [0, 1, 1, 0]), height: useTransform(textScrollHeight, [79, 80], [80, 0]) }}
                        className='w-1 block rounded-md bg-red-400' />
                    <motion.div
                        style={{ height: useTransform(textScrollHeight, [1, 80], [0, 80]) }}
                    ...
                    <span>
                        ...
                        <motion.p
                            ...
                            className='block mt-1'>Animate your headings, paragraphs, and words<br />with sleek, captivating text effects.</motion.p>
                    </span>
                </motion.span>
                <DemoPreview
                    style={{ display: useTransform(textScrollHeight, [0, 1, 80], ['none', 'block', 'none']) }} code={'code'}
                    className="w-[60%] h-[50vh] absolute left-[40%] top-4 border border-gray-700 rounded-md divide-y-2 divide-gray-700 items-start justify-start">
